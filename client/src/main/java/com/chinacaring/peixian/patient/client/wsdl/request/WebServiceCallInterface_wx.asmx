...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/WebServiceCallInterface_wx.asmx?disco" />
    ...
    <title>
	WebServiceCallInterface Web Service
</title></head>
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">WebServiceCallInterface</p><br>

      

      <span>

          <p class="intro">The following operations are supported.  For a formal definition, please review the <a href="WebServiceCallInterface_wx.asmx?WSDL">Service Description</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="WebServiceCallInterface_wx.asmx?op=get_queue_by_dept">get_queue_by_dept</a>
                
                <span>
                  <br>通过本接口可以查询所有科室的当天排队叫号信息
                </span>
              </li>
              <p>
            
              <li>
                <a href="WebServiceCallInterface_wx.asmx?op=get_queue_for_patient">get_queue_for_patient</a>
                
                <span>
                  <br>通过本接口可以查询患者当天的排队叫号信息
                </span>
              </li>
              <p>
