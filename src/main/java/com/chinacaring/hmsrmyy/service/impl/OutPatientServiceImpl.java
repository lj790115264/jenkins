...
import com.chinacaring.hmsrmyy.dto.his.request.prescription.PrescriptionRequestHis;
import com.chinacaring.hmsrmyy.dto.his.request.unpaidOutpatient.UnpaidOutpatientRequestHis;
...
import com.chinacaring.hmsrmyy.dto.his.response.outpatientConfirm.OutpatientConfirmResponseHis;
import com.chinacaring.hmsrmyy.dto.his.response.prescription.PrescriptionResponseHis;
import com.chinacaring.hmsrmyy.dto.his.response.unpaidOutpatient.UnpaidOutpatientResponseHis;
...
public class OutPatientServiceImpl implements OutPatientService{
    ...
    public Object getUnpaidClinicRecords(UnpaidOutpatientRequest unpaidOutpatientRequest) throws CommonException, ParseException {
        ...
        List<com.chinacaring.hmsrmyy.dto.his.response.unpaidOutpatient.ItemType> itemTypes = recordsResponseHis.getItems().getItem();
    ...
    public Object getPrescription(PrescriptionRequest prescriptionRequest) throws CommonException, ParseException {
        ...
        List<com.chinacaring.hmsrmyy.dto.his.response.prescription.ItemType> itemTypes = recordsResponseHis.getItems().getItem();
        if (Objects.isNull(itemTypes) || itemTypes.isEmpty() ){
            throw new CommonException("暂无相关信息");
        }
